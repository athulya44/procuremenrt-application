...
<div class="container">
 ...
 <form action="{{ route('items.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <input type="text" name="item_name" placeholder="Enter  Name" class="form-control">
    </div>
    <div class="form-group">
       <label for="content">Inventory Location:</label>
       <input type="text" name="inventory_location" placeholder="Inventory Location" class="form-control">
    ...
    <input type="text" name="stock_unit" placeholder="Enter Stock Unit" class="form-control">
    </div>
    <div class="form-group">
    <label for="unitprice">Unit Price:</label>
    <input type="text" name="unit_price" placeholder="Enter Unit Price" class="form-control">
    </div>
